...
val Context.screenWidth: Int
    get() = ScreenUtil.getScreenWidth(this)

/** 屏幕高度[Int] */
val Context.screenHeight: Int
    get() = ScreenUtil.getScreenHeight(this)

/** 状态栏高度[Int] */
val Context.statusBarHeight: Int
    get() = StatusBarUtil.getStatusBarHeight(this)
 ...
 * 在新的栈中打开
 *
 * - eg: context.startTargetActivity<LoginActivity>()
 */
 ...
 * 在新的栈中打开
 *
 * eg: context.startTargetActivity<SystemArticlesActivity>(
 *      bundleOf(ACTION_TITLE to title,ACTION_SYSTEM_ID to cid)
 *     )
 *
 */
inline fun <reified A : Activity> Context.startTargetActivity(
