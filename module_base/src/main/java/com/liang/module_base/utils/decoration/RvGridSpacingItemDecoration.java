...
public class RvGridSpacingItemDecoration extends RecyclerView.ItemDecoration {

    private final int spanCount;
    private final int spacing;
    private final boolean includeEdge;

    public RvGridSpacingItemDecoration(int spanCount, int spacing, boolean includeEdge) {
